...
Production::Production(const Symbol &_left, const deque<Symbol> &_right, const function<void(
		deque<tuple<int, Symbol, variant<long long int, double>, TokenType>> &)> &_translate) :
		left(_left), right(_right), translate(_translate) {
}

Production::Production(Symbol &&_left, deque<Symbol> &&_right, function<void(
		deque<tuple<int, Symbol, variant<long long int, double>, TokenType>> &)> &&_translate) :
